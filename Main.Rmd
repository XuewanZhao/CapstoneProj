...
jpeg("NA_in_factors.jpg", width = 600)
barplot(t(na_count))
dev.off()
...
tiff("In_sample_qtrly_return.jpg", units="in", width=6, height=4, res=300)
...
tiff("In_sample_cumu_return.jpg", units="in", width=6, height=4, res=300)
ggplot(in_sample, aes(yr+0.25*qtr)) + 
...
tiff("In_sample_r2.jpg", units="in", width=6, height=4, res=300)
ggplot(in_sample, aes(yr+0.25*qtr)) + 
